...
// Created Programs
class CreatedPrograms extends React.Component {
  ...
  async componentDidMount() {
    ...
    httpGet(apify(`app/created-programs`)).then(res => {
      if (res['success']) {
        this.setState({
                  ...
                  <div className="card-body p-0">
                    {
                      <DataTable
                        ...
                        noDataComponent={<DatatableNoRows text="There are no programs Created." />}
                        pagination
                      />
                    }
                  </div>
...
//
export default withRouter(CreatedPrograms);