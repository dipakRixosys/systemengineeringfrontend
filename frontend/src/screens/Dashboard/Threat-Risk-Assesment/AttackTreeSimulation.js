...
// Attack Tree
class AttackTreeSimulation extends React.Component {
  //
  state = {
    loading: true,
    threats: [],
  ...
  prepareThreatTypes = (threatObject = []) => {
    ...
    if (threatObject && threatObject['Identification'] && threatObject['Identification']['Threats']) { //
...
// Attack Tree
export default withRouter(AttackTreeSimulation);